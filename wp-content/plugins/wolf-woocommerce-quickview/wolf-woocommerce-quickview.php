<?php
/**
 * Plugin Name: Wolf WooCommerce Quickview
 * Plugin URI: https://wolfthemes.com/plugin/wolf-woocommerce-quickview
 * Description: Add WooCommerce product quickview to your theme
 * Version: 1.0.9
 * Author: WolfThemes
...
if ( ! class_exists( 'Wolf_WooCommerce_Quickview' ) ) {
	...
	class Wolf_WooCommerce_Quickview {
		...
		/**
		 * @var Wolf WooCommerce Quickview The single instance of the class
		 */
		...
		/**
		 * Main Wolf WooCommerce Quickview Instance
		 *
		 * Ensures only one instance of Wolf WooCommerce Quickview is loaded or can be loaded.
		 *
		 * @static
		 * @see WVCCB()
		 * @return Wolf WooCommerce Quickview - Main instance
		 */
		...
		/**
		 * Wolf WooCommerce Quickview Constructor.
		 */
		...
		/**
		 * Init Wolf WooCommerce Quickview when WordPress Initialises.
		 */
