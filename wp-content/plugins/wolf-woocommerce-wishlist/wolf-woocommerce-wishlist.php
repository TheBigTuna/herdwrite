<?php
/**
 * Plugin Name: Wolf WooCommerce Wishlist
 * Plugin URI: http://wolfthemes.com/plugin/wolf-woocommerce-wishlist
...
if ( ! class_exists( 'Wolf_WooCommerce_Wishlist' ) ) {
	...
	class Wolf_WooCommerce_Wishlist {
		...
		/**
		 * @var Wolf WooCommerce Wishlist The single instance of the class
		 */
		...
		/**
		 * Main Wolf WooCommerce Wishlist Instance
		 *
		 * Ensures only one instance of Wolf WooCommerce Wishlist is loaded or can be loaded.
		 *
		 * @static
		 * @see WE()
		 * @return Wolf WooCommerce Wishlist - Main instance
		 */
		...
		/**
		 * Wolf WooCommerce Wishlist Constructor.
		 */
		...
		/**
		 * Init Wolf WooCommerce Wishlist when WordPress Initialises.
		 */
