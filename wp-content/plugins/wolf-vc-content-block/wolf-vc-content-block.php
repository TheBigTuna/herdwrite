 ...
 * Plugin URI: http://wolfthemes.com/plugin/wolf-vc-content-block
 * Description: A WordPress plugin to create blocks.
 * Version: 1.0.8
 * Author: WolfThemes
...
if ( ! class_exists( 'Wolf_Vc_Content_Block' ) ) {
	...
	class Wolf_Vc_Content_Block {
		...
		/**
		 * @var Wolf Content Blocks The single instance of the class
		 */
		...
		/**
		 * Main Wolf Content Blocks Instance
		 *
		 * Ensures only one instance of Wolf Content Blocks is loaded or can be loaded.
		 *
		 * @static
		 * @see WVCCB()
		 * @return Wolf Content Blocks - Main instance
		 */
		...
		/**
		 * Wolf Content Blocks Constructor.
		 */
		...
		/**
		 * Function used to Init Wolf Content Blocks Template Functions - This makes them pluggable by plugins and themes.
		 */
		...
		/**
		 * Init Wolf Content Blocks when WordPress Initialises.
		 */
		...
		private function is_wrong_theme() {
			$ok = array( 'wolf-2018', 'protheme', 'iyo', 'loud', 'tune', 'retine', 'racks', 'andre', 'hares', 'glytch', 'superflick', 'phase', 'zample', 'prequelle', 'slikk', 'vonzot', 'deadlift', 'hyperbent', 'kayo', 'reinar', 'snakepit', 'alceste', 'fradence', 'firemaster', 'decibel', 'tattoopress', 'tattoopro', 'milu', 'beatit', 'daeron', 'herion', 'oglin', 'staaw' );
