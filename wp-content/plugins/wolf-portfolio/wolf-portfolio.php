 ...
 * Plugin URI: https://wolfthemes.com/plugin/wolf-portfolio
...
if ( ! class_exists( 'Wolf_Portfolio' ) ) {
	...
	class Wolf_Portfolio {
		...
		/**
		 * @var Wolf Portfolio The single instance of the class
		 */
		...
		/**
		 * Main Wolf Portfolio Instance
		 *
		 * Ensures only one instance of Wolf Portfolio is loaded or can be loaded.
		 *
		 * @static
		 * @see WG()
		 * @return Wolf Portfolio - Main instance
		 */
		...
		/**
		 * Function used to Init Wolf Portfolio Template Functions - This makes them pluggable by plugins and themes.
		 */
		...
		/**
		 * Init Wolf Portfolio when WordPress Initialises.
		 */
