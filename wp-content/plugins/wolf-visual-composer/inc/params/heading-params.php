<?php
/**
 * Wolf WPBakery Page Builder Extension custom heading params
 *
 * @author WolfThemes
 * @category Core
...
function wvc_heading_params() {
	return apply_filters( 'wvc_custom_heading_params', array(
		...
		'params' => array(
			...
			array(
				...
				'value' => '',
				'dependency' => array( 'element' => 'add_background', 'value' => array( 'true' ) ),
