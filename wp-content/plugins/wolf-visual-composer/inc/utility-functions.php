<?php
/**
 * Wolf WPBakery Page Builder Extension utility functions
 *
 * @author WolfThemes
 * @category Core
...
function wvc_vc_purchase_url() {
	return esc_url( 'https://codecanyon.net/item/visual-composer-page-builder-for-wordpress/242431?ref=wolf-themes' );
}
