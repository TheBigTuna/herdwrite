<?php
/**
 * Advanced slider shortcode template
 *
 * @author WolfThemes
 * @category Core
...
$class .= " wvc-advanced-slider-container wvc-slider-nav-font-tone-$nav_tone wvc-element";
...
$output .= '>';
	...
	$output .= "<div $slider_data class='flexslider wvc-advanced-slider' id='wvc-advanced-slider-$rand'>";
		$output .= '<ul class="slides">';

			$output .= wpb_js_remove_wpautop( $content );

		$output .= '</ul><!--.slides-->';
	$output .= '</div><!--.wvc-advanced-slider-->';
$output .= '</div><!--.wvc-advanced-slider-container-->';
