				...
				<td colspan="6" class="actions">
					<div class="twp-back-shop">
						<a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>" class="twp-btn twp-btn-primary twp-btn-medium">
                            ...
                            <?php esc_attr_e( 'Back To Shop', 'store-lite' ); ?>
                        </a>
					</div>
        ...
        <div class="col-md-4">
            <div class="twp-coupon-code">
                ...
                <?php if ( wc_coupons_enabled() ) { ?>
                    <div class="coupon">
                        <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'store-lite' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'store-lite' ); ?>"><?php esc_attr_e( 'Apply coupon', 'store-lite' ); ?></button>
