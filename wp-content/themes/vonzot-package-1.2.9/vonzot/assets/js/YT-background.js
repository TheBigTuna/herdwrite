		...
		init : function ( $container ) {
			...
			setTimeout( function() {
				...
				if ( typeof window.onYouTubePlayerAPIReady !== 'undefined' ) {
					if ( typeof window.VonzotOtherYTAPIReady === 'undefined' ) {
						window.VonzotOtherYTAPIReady = [];
					}
					window.VonzotOtherYTAPIReady.push( window.onYouTubePlayerAPIReady );
				}
				...
				window.onYouTubePlayerAPIReady = function() {
					...
					if ( typeof window.VonzotOtherYTAPIReady !== 'undefined' ) {
						if ( window.VonzotOtherYTAPIReady.length ) {
							window.VonzotOtherYTAPIReady.pop()();
						}
					}
				};
			}, 2 );
