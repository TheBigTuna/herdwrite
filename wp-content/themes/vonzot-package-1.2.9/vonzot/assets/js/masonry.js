	...
	return {
		...
		infiniteScroll : function () {
			...
			$container.infinitescroll( {
				...
				loading: {
					finishedMsg: VonzotParams.l10n.infiniteScrollEndMsg,
					msgText : VonzotParams.l10n.infiniteScrollMsg,
					img: VonzotParams.infiniteScrollGif,
