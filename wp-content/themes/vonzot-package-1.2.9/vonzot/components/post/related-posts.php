 ...
 * @version 1.2.9
 */
$related_posts_query = vonzot_related_post_query();
...
<section class="related-post-container entry-section">
	<div class="related-posts clearfix"><?php if( $related_posts_query->have_posts() ) : ?>
			<h3 class="related-post-title"><?php echo apply_filters( 'vonzot_related_posts_text', esc_html__( 'More Posts', 'vonzot' ) ); ?></h3>
