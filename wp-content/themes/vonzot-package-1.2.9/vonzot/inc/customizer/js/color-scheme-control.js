...
;( function( api, $ ) {
	...
	var colorSchemeTemplate = wp.template( 'vonzot-color-scheme' ),
		fontsTemplate = wp.template( 'vonzot-fonts' ),
		layoutTemplate = wp.template( 'vonzot-layout' ),
	...
	*--------------------------------------------------------------------------------------------*/
	...
	function updateColorSchemeCSS() {
		...
		// jscs:disable
		colors.border_color = Color( colors.strong_text_color ).toCSS( 'rgba', 0.15 );
		// jscs:enable
