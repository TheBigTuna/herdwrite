...
;( function( $ ) {
	 ...
	 * Background
	 */
	var colorSchemeStyle = $( '#vonzot-color-scheme-css' ),
		fontsStyle = $( '#vonzot-fonts-css' ),
		layoutStyle = $( '#vonzot-layout-css' ),
		api = wp.customize,
		backgrounds = {
	...
	if ( ! colorSchemeStyle.length ) {
		colorSchemeStyle = $( 'head' ).append( '<style type="text/css" id="vonzot-color-scheme-css" />' )
			.find( '#vonzot-color-scheme-css' );
	}

	// Fonts style tag
	if ( ! fontsStyle.length ) {
		fontsStyle = $( 'head' ).append( '<style type="text/css" id="vonzot-fonts-css" />' )
			.find( '#vonzot-fonts-css' );
	}

	// Layout style tag
	if ( ! layoutStyle.length ) {
		layoutStyle = $( 'head' ).append( '<style type="text/css" id="vonzot-layout-css" />' )
			.find( '#vonzot-layout-css' );
	}
	...
	api( 'menu_width', function( value ) {
		value.bind( function( to ) {
			...
			VonzotUi.centeredLogoOffset();
			VonzotUi.subMenuDirection();
		} );
	} );
	...
	api( 'footer_type', function( value ) {
		value.bind( function( to ) {
			...
			VonzotUi.footerPageMarginBottom();
		} );
	} );
