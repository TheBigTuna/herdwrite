...
final class Vonzot_Framework {
	...
	public function __construct( $options = array() ) {
		...
		do_action( 'vonzot_framework_loaded' );
	}
	...
	public function include_vc_modules() {
		/* Includes VC modules */
		vonzot_include( 'config/vc-post-modules.php' );
	}
	...
	public function includes() {
		...
		vonzot_include( 'config/config.php' );

		/* Theme custom functions */
		vonzot_include( 'inc/theme-functions.php' );
	...
	public function admin_includes() {
		...
		/* About page */
		vonzot_include( '/inc/admin/class-about-page.php' );

		/* Includes recommend plugins file if available */
		vonzot_include( 'config/plugins.php' );

		/* Includes demo importer file if available */
		vonzot_include( 'config/importer.php' );

		/* Update actions file if available */
		vonzot_include( 'config/update.php' );

		/* Metaboxes file if available */
		vonzot_include( 'config/metaboxes.php' );
	}
	...
	public function setup() {
		 ...
		 * to change 'vonzot' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'vonzot', get_template_directory() . '/languages' );
		 ...
		 */
		add_theme_support( 'custom-header', apply_filters( 'vonzot_custom_header_args', array(
				'header-text' => false,
	...
	public function set_post_thumbnail_sizes() {
		...
		$image_sizes = apply_filters( 'vonzot_image_sizes', $this->options['image_sizes'] );
	...
	public function register_nav_menus() {
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus( apply_filters( 'vonzot_menus', $this->options['menus'] ) );
		}
	}
} // end class

/**
 * Returns the main instance of VONZOT to prevent the need to use globals.
 *
 * @return Vonzot_Framework
 */
function VONZOT( $options = array() ) {
	return new Vonzot_Framework( $options );
}